...
namespace TreinamentoML
{
    public partial class SentimentModel
    {
        public const string RetrainFilePath =  @"C:\Users\John\Desktop\ClassificadorDeTextoComIA\TreinamentoML\TreinamentoML\dadosTreinamentos.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.03125F,L2Regularization=1.0579544F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
